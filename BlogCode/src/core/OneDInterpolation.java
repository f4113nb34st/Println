 ...
 *
 */
public class OneDInterpolation extends SimpleCore implements KeyListener
{
	public static void main(String[] args)
	{
		...
		{
			//general init stuff
			OneDInterpolation main = new OneDInterpolation("1D Interpolation");
			main.init();
			main.renderLoop();
	...
	//pass title and sizes
	public OneDInterpolation(String title)
	{
